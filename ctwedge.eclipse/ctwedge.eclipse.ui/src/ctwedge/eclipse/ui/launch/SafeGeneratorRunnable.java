...
import ctwedge.eclipse.ui.views.generator.TestSuiteView;
import ctwedge.eclipse.util.IsStoppedPolling;
				...
				if (output != null) {
					try {
						...
						TestSuiteView view = (TestSuiteView) PlatformUI.getWorkbench().getActiveWorkbenchWindow()
								.getActivePage().showView(ctwedge.eclipse.ui.Activator.PLUGIN_ID + ".output",
										ctwedge.eclipse.ui.Activator.PLUGIN_ID + ".outputSecondaryID"

...
public class CTwedgeLaunchTabGroup implements ILaunchConfigurationTabGroup {

	private ILaunchConfigurationTab[] tabs = new ILaunchConfigurationTab[1];

	public CTwedgeLaunchTabGroup() {
		tabs[0] = new CTWedgeTab(); // new org.eclipse.jdt.debug.ui.launchConfigurations.JavaMainTab();
	}

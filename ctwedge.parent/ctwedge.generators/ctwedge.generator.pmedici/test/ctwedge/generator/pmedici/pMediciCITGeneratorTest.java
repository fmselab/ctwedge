...
import ctwedge.generator.pmedici.PMediciCITGenerator;
import ctwedge.generator.util.Utility;
import ctwedge.util.TestSuite;
import ctwedge.util.ext.ICTWedgeModelProcessor;
import ctwedge.util.ext.ICTWedgeTestGenerator;

public class pMediciCITGeneratorTest {
	...
	static PMediciCITGenerator medici = new PMediciCITGenerator(); 
	...
	public void test_bench() {
		try {
			PMediciCITGenerator generator = new PMediciCITGenerator();

 ...
 */ 
public abstract class ICTWedgeTestGenerator extends ICTWedgeModelProcessor 
  ...
  final public TestSuite generateTestsAndInfo(CitModel model, 
      boolean ignoreConstraints, int nWise) throws CTWedgeException { 
  ...
  private void ICitLabTestGeneratorSetter(CitModel model, 
      boolean ignoreConstraints, int nWise) { 
    this.citModel = model; 

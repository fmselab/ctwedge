...
2. Create any empty project (or use an existing one), then press `New` -> `Other...`, and choose `New CTWedge File Wizard`. Complete the wizard entering the filename and the project into which create the CTWedge model file (with the extension `.ctw`). Then open that file.
<img src="https://fmselab.github.io/ctwedge/images/newFile0.png" width="400" alt="Create New File 0" />
<img src="https://fmselab.github.io/ctwedge/images/newFile1.png" width="400" alt="Create New File 1" />
<img src="https://fmselab.github.io/ctwedge/images/newFile2.png" width="400" alt="Create New File 2" />
...
<img src="https://fmselab.github.io/ctwedge/images/export.png" width="400" alt="Export" />
